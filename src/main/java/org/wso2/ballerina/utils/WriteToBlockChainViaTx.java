...
@BallerinaFunction(
        ...
        functionName = "writeBlockchainRecordViaTx",
...
public class WriteToBlockChainViaTx extends BlockingNativeCallableUnit {
    ...
    public void execute(Context context) {
        ...
        String result = writeBlockchainRecordViaTx(key, value, blockChainAPIURL, account, password);
