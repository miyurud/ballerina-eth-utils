...
public extern function encryptRSAWithPublicKeyPlainText(string key, string value) returns string;
...
public extern function fileExists(string path) returns string;
public extern function stringToBinaryString(string data) returns string;
public extern function binaryStringToString(string data) returns string;